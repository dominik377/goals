export const actionGoalFieldToStatusLookup = {
  'task': ['assigned', 'asap', 'convenient', 'later', 'consider', 'mind', 'undefined'],
  'practise': ['assigned', 'asap', 'convenient', 'later', 'consider', 'mind',  'undefined'],
  'goal': ['funded' , 'semi-funded' , 'near' ,'seminear' , 'far' , 'lowInterest', 'veryfar', 'undefined'],
  'field': ['funded' , 'semi-funded' , 'near' ,'seminear' , 'far' , 'lowInterest', 'veryfar', 'undefined'],
  'smallproject': ['focus' ,'active' , 'background', 'backgroundLow', 'intend', 'later', 'mind', 'lowInterest', 'unrealistic',  'undefined'],
  'largeproject': ['focus' ,'active' , 'background' , 'backgroundLow', 'intend', 'later', 'mind', 'lowInterest', 'unrealistic',  'undefined'],
