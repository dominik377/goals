export const actionGoalFieldToStatusLookup = {
  ...
  'smallproject': ['focus' ,'active' , 'background' , 'intend', 'later', 'mind', 'lowInterest', 'unrealistic',  'undefined'],
  'largeproject': ['focus' ,'active' , 'background' , 'intend', 'later', 'mind', 'lowInterest', 'unrealistic',  'undefined'],
